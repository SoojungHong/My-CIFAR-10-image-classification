...
def eval_mAP(model): 
    ...
    precisions_per_class = metric.precision_per_class(all_labels, all_predictions) # precision per class
    recall_per_class = metric.recall_per_class(all_labels, all_predictions) # recall per class

    avg_precision_per_class = metric.average_precision(precisions_per_class, recall_per_class)
    mAP = metric.meanAveragePrecision(avg_precision_per_class, len(classes))
